...
def generate_speaker_script(context, api_key):
    question = """
    For each PowerPoint slide provided above, write a 1-2 minutes script for each slide that effectively conveys the key points.Generate the script for each slide separetly.
